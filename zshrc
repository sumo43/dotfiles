...
alias google-chrome=/Applications/$chrome_app/Contents/MacOS/$chrome

export PATH="$PATH:/Users/artem/flutter/bin"
export PATH="$PATH:/Users/artem/Documents/scrape/driver/chromedriver"
...
export PATH="$PATH:/Users/artem/.cargo/bin"
